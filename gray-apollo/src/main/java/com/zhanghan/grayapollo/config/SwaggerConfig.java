...
public class SwaggerConfig {
    ...
    //定义扫描的controller的路径
    private final static String controllerPath = "com.zhanghan.grayapollo.controller";
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("gray_apollo swagger")
                .description("gray_apollo，https://blog.csdn.net/zhanghan18333611647")
